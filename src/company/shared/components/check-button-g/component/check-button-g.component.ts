...
@Component({
  ...
  template: `
   ...
   <div [fxLayout]="positionHtmlRow" *ngFor="let radio of this.entities | keyvalue">
     ...
     <mat-checkbox #radioButton value={{radio.value}} (click)="setValueUpdate(radioButton.value)">
                    {{radio.key | checkOptionDisplayNameHandle}}
      </mat-checkbox>
     </div>
   </div>
  </div>
...
export class CheckButtonGComponent implements OnChanges, AfterViewInit{
